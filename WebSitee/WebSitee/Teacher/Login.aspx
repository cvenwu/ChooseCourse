        ...
        <div class="col-md-8">
            <section id="loginForm">
                <div class="form-horizontal">
                    <h4>请各位老师根据职工号和密码进行登录，如果忘记密码，请自己去院教务办重置密码！</h4>
                    <hr />
                    ...
                    <div class="form-group">
                        <asp:Label runat="server" AssociatedControlID="UserName" CssClass="col-md-2 control-label">教职工号</asp:Label>
                        <div class="col-md-10">
                            <asp:TextBox runat="server" ID="UserName" CssClass="form-control" />
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="UserName"
                                CssClass="text-danger" ErrorMessage="“教职工号”字段是必填字段。" />
                        </div>
                    </div>
                    <div class="form-group">
